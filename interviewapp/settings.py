...
from interviewapp import authmiddleware
...
SECRET_KEY = 'django-insecure-l2v=fj9y0+%=^^nul-2c6^i^t23lw9btb88mk21=-hbu7tbblw'
...
MIDDLEWARE = [
    ...
    'interviewapp.authmiddleware.AuthMiddleware'
]
